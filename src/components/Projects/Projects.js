...
import customer from "../../Assets/Projects/Customer Portal.jpg";
import suicide from "../../Assets/Projects/suicide.png";
import node from "../../Assets/Projects/Api.png";
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={6} className="project-card">
            <ProjectCard
              ...
              description="Developed the front-end design for an Admin Client interface, responsible for displaying customer information such as name, services, and status. The interface also included features to manage both customers and their services effectively."
            />
          </Col>
